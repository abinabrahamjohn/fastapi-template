...
[![codecov](https://codecov.io/gh/abinabrahamjohn/fastapi-template/branch/main/graph/badge.svg?token=fastapi-template_token_here)](https://codecov.io/gh/abinabrahamjohn/fastapi-template)
[![CI](https://github.com/abinabrahamjohn/fastapi-template/actions/workflows/main.yml/badge.svg)](https://github.com/abinabrahamjohn/fastapi-template/actions/workflows/main.yml)

Awesome fastapi_template created by abinabrahamjohn

## Install

from source
```bash
git clone https://github.com/abinabrahamjohn/fastapi-template fastapi_template
cd fastapi_template
make install
```
